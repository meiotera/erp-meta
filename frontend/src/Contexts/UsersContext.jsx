...
import { listarFuncionarios, listarDataseHorarios } from '../../api/funcionario';
...
export const UsersProvider = ({ children }) => {
    ...
    return (
        <UsersContext.Provider value={{ funcionarios, setFuncionarios, loading, setLoading, agenda, setAgenda, fetchAgenda, postAgendamento, message, funcionarioId }}>
            {children}
